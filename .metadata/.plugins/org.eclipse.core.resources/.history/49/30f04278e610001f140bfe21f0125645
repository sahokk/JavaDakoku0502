...
public class SettingDialog extends Dialog implements ActionListener, WindowListener {
	...
	public TextField getJcLoginIdField() {
		return jcLoginIdField;
	}

	public TextField getJcLoginPassField() {
		return jcLoginPassField;
	}

	public TextField getrLoginIdField() {
		return rLoginIdField;
	}

	public TextField getrLoginPassField() {
		return rLoginPassField;
	}
